...
from app.schemas.artifacts import ArtifactPreviewRead, ArtifactRead
...
@router.get("/{artifact_id}/preview", response_model=ArtifactPreviewRead)
async def preview_artifact(
    ...
    preview = artifact_service.build_preview(artifact)
    return ArtifactPreviewRead.model_validate(preview)
